## [3.9.0-dev.1](https://github.com/Aria-NL/piko/compare/v3.8.0...v3.9.0-dev.1) (2026-08-15)

### 🐛 Bug Fixes

* **Instagram:** block permission onboarding screens ([#1686](https://github.com/Aria-NL/piko/issues/1686)) ([de6bcea](https://github.com/Aria-NL/piko/commit/de6bceaa0ceace832a63f8c116c8efc562a5c488))
* **Instagram:** Check and add external downloader options in settings ([c6651df](https://github.com/Aria-NL/piko/commit/c6651df52aab328755ea4138f87ab079cad25cf1))
* **Instagram:** Fix default flag state while extracting recommended flags map ([82785a8](https://github.com/Aria-NL/piko/commit/82785a858bae02ee11bd8ff07f06fa260bcceea2))
* **Instagram:** Fix reels current media logic ([40836e8](https://github.com/Aria-NL/piko/commit/40836e83e10b1f023e7ec4c1dca4f1407ba6d638))
* **Instagram:** Fix register issue while hooking reel overflow menu ([83786a8](https://github.com/Aria-NL/piko/commit/83786a8d379b7ae05bfaa73ab07c94172ba9d9d3))
* **Instagram:** Fix user data entity fingerprints ([5d83613](https://github.com/Aria-NL/piko/commit/5d8361334805470b2cc94fcfd0f2e4623a4d6be0))
* **Instagram:** handle missing context for comment media downloads ([#1677](https://github.com/Aria-NL/piko/issues/1677)) ([4588900](https://github.com/Aria-NL/piko/commit/45889000685d29e07bdf223050ebaa0eadc38eb2))
* **instagram:** pass current carousel index to reel overflow buttons ([#1586](https://github.com/Aria-NL/piko/issues/1586)) ([a80bf4a](https://github.com/Aria-NL/piko/commit/a80bf4af5bdc1ff402793dbe0209a642c015b3fa))
* **instagram:** patch GRAY_1600 to fix Compose surfaces staying gray in AMOLED mode ([#1596](https://github.com/Aria-NL/piko/issues/1596)) ([07d08d4](https://github.com/Aria-NL/piko/commit/07d08d4ba4a291bb3f454ec3e92ca9cb6f07975d))
* **Instagram:** preserve reels media control colors ([#1681](https://github.com/Aria-NL/piko/issues/1681)) ([3befb48](https://github.com/Aria-NL/piko/commit/3befb4800a92a2a3046b394a4e6c230083fc8bb2))
* **instagram:** prevent inbox action bar verifier crash ([b65cdb2](https://github.com/Aria-NL/piko/commit/b65cdb26c195891a12e2b7ad64c90cb21e56b042))
* **Instagram:** Prevent notification registration crash ([#1678](https://github.com/Aria-NL/piko/issues/1678)) ([4f67a78](https://github.com/Aria-NL/piko/commit/4f67a78430871afa0eff393d9127f78fd11a85e0))
* **instagram:** restore amoled after dark mode returns ([#1679](https://github.com/Aria-NL/piko/issues/1679)) ([96536bb](https://github.com/Aria-NL/piko/commit/96536bbf24544219e0bd279ed6bba357e2b3da28))
* **instagram:** restore profile action bar hooks ([5cf2a42](https://github.com/Aria-NL/piko/commit/5cf2a427c2f8b3831276fe8cbc6a12178aa3dbe4))
* **Twitter:** "Change app icon" is broken on recent X versions ([#1624](https://github.com/Aria-NL/piko/issues/1624)) ([350779d](https://github.com/Aria-NL/piko/commit/350779d06bdf8c86992332387062bb42a6e236bc))
* **Twitter:** Fix `More information on profile` fingerprint on 12.11 ([3b5c945](https://github.com/Aria-NL/piko/commit/3b5c94596dc45af901c0c6efbd72af0e03a12e9e))
* **Twitter:** Fix check and add `more info on profile` preference ([97f9dca](https://github.com/Aria-NL/piko/commit/97f9dcaad76e6bd61f5a3347ced7e778155f47b1))
* **Twitter:** Fix inverted upsell flag boolean ([8a8b9e1](https://github.com/Aria-NL/piko/commit/8a8b9e1a92da7d80419679ab0c900647bffed44a))
* **twitter:** replace ic_vector_x logo in Bring back twitter patch ([7b6c7e9](https://github.com/Aria-NL/piko/commit/7b6c7e9949422a470563a50cb1efd36d0416fa50))

### ✨ New Features

* **instagram:** add material you and amoled theme controls ([#1631](https://github.com/Aria-NL/piko/issues/1631)) ([840492a](https://github.com/Aria-NL/piko/commit/840492a46c603fb99e55ec03fb1ec47c735c169a))
* **Instagram:** Added `Recommended flags` section ([ff31eda](https://github.com/Aria-NL/piko/commit/ff31eda2ea878c77820c455088b4d23c561e049a))
* **Instagram:** Added mappings for `439.0.0.37.89` ([b335af3](https://github.com/Aria-NL/piko/commit/b335af3f20cefe15d6f5342fd5cc41d692eb9fac))
* **Instagram:** Added more options in profile options menu ([#1638](https://github.com/Aria-NL/piko/issues/1638)) ([ad61869](https://github.com/Aria-NL/piko/commit/ad61869cc0711670f83fea67c2bd959b95a0ad62))
* **Instagram:** Added some recommended flags ([40ddc7e](https://github.com/Aria-NL/piko/commit/40ddc7ee525e351ae57e71055a81d995207e9917))
* **Instagram:** Added some recommended flags ([#1651](https://github.com/Aria-NL/piko/issues/1651)) ([1cb0687](https://github.com/Aria-NL/piko/commit/1cb068703fc101903272bea21fc93fe12ddde662))
* **Instagram:** Made `Recommended flags` into patch ([f81fc79](https://github.com/Aria-NL/piko/commit/f81fc7992792a72ecfc7d006590db9a506c86caa))
* **Instagram:** New patch to block onboarding permission prompts ([9b6e569](https://github.com/Aria-NL/piko/commit/9b6e56956ecb6df916afc1743a6cbb3b8e463b33))
* **Twitter:** Add Dynamic color switch toggle ([#1582](https://github.com/Aria-NL/piko/issues/1582)) ([c3de8d8](https://github.com/Aria-NL/piko/commit/c3de8d8df101203139ff3171bf8f600ef3eef028))

### 🚀 Updated App Support

* **Instagram:** Add support for `439.0.0.37.89` ([3e38d22](https://github.com/Aria-NL/piko/commit/3e38d22c56b37ded2861be7d24f0afea0f0c7034))
* **Twitter:** Add support for `12.11.0-release.0` ([cdca6a8](https://github.com/Aria-NL/piko/commit/cdca6a84f94366aa91c1c2fcb533056413a95d61))

### 🔧 Improvements

* **Instagram:** Improve piko settings ([#1684](https://github.com/Aria-NL/piko/issues/1684)) ([17662c3](https://github.com/Aria-NL/piko/commit/17662c3d311a093b4f35545db5ba73d4c8547a6d))
* **Instagram:** refresh recommended flags after download ([#1685](https://github.com/Aria-NL/piko/issues/1685)) ([85057c0](https://github.com/Aria-NL/piko/commit/85057c09a76f2efbd481f0ffb6454c40d067cfb7))
* **Instagram:** Turn off `Disable analytics` by default ([#1674](https://github.com/Aria-NL/piko/issues/1674)) ([753a70b](https://github.com/Aria-NL/piko/commit/753a70be81449c27f0a8e056f7f0e938a11e964e))
* **Twitter:** improve more profile info ([#1687](https://github.com/Aria-NL/piko/issues/1687)) ([46cb754](https://github.com/Aria-NL/piko/commit/46cb754e48b66606f19804b610cd085d54f5d173))
